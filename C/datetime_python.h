#ifndef DATETIME_PYTHON_H
#define DATETIME_PYTHON_H
...
{
	static PyObject* convert(boost::gregorian::date const & d)
	{
...
struct date_from_python_date
{
	date_from_python_date()
	{
		boost::python::converter::registry::push_back(
			&convertible, &construct, boost::python::type_id<boost::gregorian::date>());
	}
...
void bind_datetime()
{
	...
	to_python_converter<const boost::gregorian::date, date_to_python_date>();
